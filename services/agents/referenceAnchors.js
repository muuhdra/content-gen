...
function summarizeReferencePurpose(reference) {
  ...
  if (label === "character") {
    return "preserve subject identity, face, silhouette and wardrobe cues";
  }

  if (label === "scene") {
    return "preserve environment, geography, framing and location logic";
  }

  if (label === "object") {
    return "preserve important props, vehicles, devices or hero objects";
  }
