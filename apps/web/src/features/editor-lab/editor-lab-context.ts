...
import type { CaptionLabPreset } from "./components/caption-lab/caption-lab-preset";
import type { MusicLabPreset } from "./components/audio-lab/music/music-lab-preset";
import type { SoundsLabPreset } from "./components/audio-lab/sounds/sounds-lab-preset";
import type { EffectsLabPreset } from "./components/effect-lab/effects-lab-preset";
import type { GraphicsLabPreset } from "./components/graphic-lab/graphics-lab-preset";
import type { ProjectDraft } from "@/features/projects/utils/project-draft";
import type { ProjectRecord, ProjectReferenceAsset } from "@/lib/projects-api";
...
export interface EditorLabContextType {
  ...
  setReferences: Dispatch<SetStateAction<ProjectReferenceAsset[]>>;
